...
class InHandManipulationEnv(DirectRLEnv):
    ...
    def __init__(self, cfg: XHandReposeEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        # display the goal cube above the in-hand cube (XHand layout, not Shadow's)
        self.goal_pos[:, :] = torch.tensor([0.0, 0.1, 0.95], device=self.device)
