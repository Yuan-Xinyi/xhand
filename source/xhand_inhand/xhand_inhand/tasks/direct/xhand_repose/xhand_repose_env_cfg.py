...
class XHandReposeEnvCfg(DirectRLEnvCfg):
    ...
    # goal = 1-DOF heading: rotate the pen's long axis about world Z to a target
    # azimuth angle (0..360 deg). Only the heading is scored; tilt about/off Z ignored.
    goal_heading_only = True
    # (axis_only_alignment is the 2-DOF "point anywhere on the sphere" mode; ignored
    #  while goal_heading_only is True, kept for reference.)
